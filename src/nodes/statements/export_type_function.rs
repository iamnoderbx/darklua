...
pub struct ExportTypeFunctionTokens {
    pub export: Token,
    pub r#type: Token,
    pub function_body: FunctionBodyTokens,
}

impl ExportTypeFunctionTokens {
    super::impl_token_fns!(target = [export, r#type, function_body]);
}

impl std::ops::Deref for ExportTypeFunctionTokens {
...
impl std::ops::DerefMut for ExportTypeFunctionTokens {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct ExportTypeFunctionStatement {
    ...
    tokens: Option<Box<ExportTypeFunctionTokens>>,
}

impl ExportTypeFunctionStatement {
    pub fn new(
    ...
    pub fn with_tokens(mut self, tokens: ExportTypeFunctionTokens) -> Self {
        self.tokens = Some(tokens.into());
        self
    }

    #[inline]
    pub fn set_tokens(&mut self, tokens: ExportTypeFunctionTokens) {
        self.tokens = Some(tokens.into());
    }

    #[inline]
    pub fn get_tokens(&self) -> Option<&ExportTypeFunctionTokens> {
        self.tokens.as_deref()
    }

    #[inline]
    pub fn mutate_tokens(&mut self) -> Option<&mut ExportTypeFunctionTokens> {
...
mod test {
    ...
    fn has_parameter_is_true_when_single_param_matches() {
        let func =
            ExportTypeFunctionStatement::from_name("foo", Block::default()).with_parameter("bar");
    ...
    fn has_parameter_is_true_when_at_least_one_param_matches() {
        let func = ExportTypeFunctionStatement::from_name("foo", Block::default())
            .with_parameter("bar")
            .with_parameter("baz");
